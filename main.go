...
func main() {
	...
	//How does one know to use *file here
	reader := csv.NewReader(filehandle)
...
type Physician struct {
	...
	ParticipatedInTheMedicareMaintenanceOfCertificationProgram string
	CommittedToHeartHealthThroughTheMillionHeartsInitiative    string
	specialtyID                                                string
}
